...
val applications = mapOf(
    "runPricingService" to ("pricing" to "io.ringloom.samples.marketdata.pricing.MarketDataPricingApp"),
    "runMarketTerminal" to ("terminal" to "io.ringloom.samples.marketdata.terminal.MarketDataTerminalApp"),
)
